				...
				<ul className="nav navbar-nav">
					<li onMouseLeave={() => this.changeOpen()}
						...
						<a href="javascript:;" onClick={() => this.changeOpen()}
							...
							<img src="https://static.thenounproject.com/png/17241-200.png" className="user-image" alt="User Image" />
							<span className="hidden-xs">{name}</span> </a>
						<ul className="dropdown-menu">
							<li className="user-header">
								<img src="https://static.thenounproject.com/png/17241-200.png" className="img-circle" alt="User Image" />
